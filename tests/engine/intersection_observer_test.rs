//! Comprehensive unit tests for IntersectionObserver implementation in Boa engine

use boa_engine::{Context, Source};

#[test]
fn test_intersection_observer_constructor_availability() {
    let mut context = Context::default();

    // Test that IntersectionObserver exists as a function
    let result = context.eval(Source::from_bytes("typeof IntersectionObserver"));
    assert!(result.is_ok());
...
#[test]
fn test_intersection_observer_constructor_with_callback() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_constructor_without_callback_fails() {
    let mut context = Context::default();
    ...
    assert!(caught_error, "IntersectionObserver constructor should require a callback");
}

#[test]
fn test_intersection_observer_constructor_with_non_function_fails() {
    let mut context = Context::default();
    ...
    let caught_error = result.unwrap().to_boolean();
    assert!(caught_error, "IntersectionObserver constructor should require a function callback");
}

#[test]
fn test_intersection_observer_methods_exist() {
    let mut context = Context::default();

    let methods = ["observe", "unobserve", "disconnect", "takeRecords"];

    for method in &methods {
        let script = format!(
            "var observer = new IntersectionObserver(function() {{}}); typeof observer.{}",
            method
        );
        let result = context.eval(Source::from_bytes(&script));
...
#[test]
fn test_intersection_observer_constructor_with_options() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_constructor_with_threshold_array() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_observe_without_target_fails() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_unobserve_without_target_fails() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_take_records_method() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_take_records_initially_empty() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_multiple_targets() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_observe_same_target_multiple_times() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_unobserve_not_observed_target() {
    let mut context = Context::default();
...
#[test]
fn test_intersection_observer_instance_isolation() {
    let mut context = Context::default();

    let script = r#"
        var observer1 = new IntersectionObserver(function() {});
        var observer2 = new IntersectionObserver(function() {});
        var target = {};
...
#[test]
fn test_intersection_observer_callback_storage() {
    let mut context = Context::default();
