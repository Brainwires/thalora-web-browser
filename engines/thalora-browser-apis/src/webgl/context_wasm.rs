...
impl WebGLRenderingContext {
    ...
    /// Create a new WebGL context for a canvas (WASM stub)
    ///
    /// In WASM builds, this returns a stub object. The actual WebGL context
    ...
    pub fn create_context(_width: u32, _height: u32, context: &mut Context) -> JsResult<JsObject> {
        // Create a stub object with WebGL constants for API compatibility
