...
fn test_get_random_values_exists() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.getRandomValues"))
        .unwrap();
...
fn test_random_uuid_exists() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.randomUUID"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_crypto_has_get_random_values_property() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("'getRandomValues' in crypto"))
        .unwrap();
    assert_eq!(result.to_boolean(), true);
}
...
fn test_crypto_has_random_uuid_property() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("'randomUUID' in crypto"))
        .unwrap();
    assert_eq!(result.to_boolean(), true);
}
...
fn test_subtle_exists() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("object")));
}
...
fn test_subtle_is_object() {
    ...
    let result = context
        .eval(Source::from_bytes(
            "crypto.subtle !== null && crypto.subtle !== undefined",
        ))
        .unwrap();
    assert_eq!(result.to_boolean(), true);
}
...
fn test_subtle_has_digest() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.digest"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_generate_key() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.generateKey"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_import_key() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.importKey"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_export_key() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.exportKey"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_encrypt() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.encrypt"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_decrypt() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.decrypt"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_sign() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.sign"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_verify() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.verify"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_derive_key() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.deriveKey"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_derive_bits() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.deriveBits"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_wrap_key() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.wrapKey"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_subtle_has_unwrap_key() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof crypto.subtle.unwrapKey"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
