...
fn test_intersection_observer_constructor_exists() {
    ...
    let result = context
        .eval(Source::from_bytes("typeof IntersectionObserver"))
        .unwrap();
...
fn test_mutation_observer_constructor_exists() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof MutationObserver"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_resize_observer_constructor_exists() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof ResizeObserver"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_performance_observer_constructor_exists() {
    let mut context = create_test_context();
    let result = context
        .eval(Source::from_bytes("typeof PerformanceObserver"))
        .unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
