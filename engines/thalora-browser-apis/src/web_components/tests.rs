...
fn test_custom_elements_exists() {
    ...
    let result = context.eval(Source::from_bytes("typeof customElements")).unwrap();
...
fn test_custom_elements_define_exists() {
    let mut context = create_test_context();
    let result = context.eval(Source::from_bytes("typeof customElements.define")).unwrap();
...
fn test_custom_elements_get_exists() {
    let mut context = create_test_context();
    let result = context.eval(Source::from_bytes("typeof customElements.get")).unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_custom_elements_when_defined_exists() {
    let mut context = create_test_context();
    let result = context.eval(Source::from_bytes("typeof customElements.whenDefined")).unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_custom_elements_upgrade_exists() {
    let mut context = create_test_context();
    let result = context.eval(Source::from_bytes("typeof customElements.upgrade")).unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
...
fn test_html_template_element_exists() {
    let mut context = create_test_context();
    let result = context.eval(Source::from_bytes("typeof HTMLTemplateElement")).unwrap();
    assert_eq!(result, JsValue::from(JsString::from("function")));
}
