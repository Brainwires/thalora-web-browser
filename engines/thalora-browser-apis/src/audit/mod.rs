...
pub fn get_api_tests() -> Vec<ApiTest> {
    vec![
        ...
        ApiTest {
            ...
            test_expr: "typeof FileSystemHandle === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::High,
            description: "OPFS base handle",
        },
        ApiTest {
            name: "FileSystemFileHandle",
            test_expr: "typeof FileSystemFileHandle === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::High,
            description: "OPFS file handle",
        },
        ApiTest {
            name: "FileSystemDirectoryHandle",
            test_expr: "typeof FileSystemDirectoryHandle === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::High,
            description: "OPFS directory handle",
        },
        ApiTest {
            name: "FileSystemWritableFileStream",
            test_expr: "typeof FileSystemWritableFileStream === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::High,
            description: "OPFS writable stream",
        },
        ApiTest {
            name: "FileSystemSyncAccessHandle",
            test_expr: "typeof FileSystemSyncAccessHandle === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::High,
            description: "OPFS sync access handle (worker-only)",
        },
        ApiTest {
            name: "navigator.storage.getDirectory",
            test_expr: "typeof navigator.storage.getDirectory === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::Critical,
            description: "OPFS root accessor",
        },
        ApiTest {
            name: "FileSystemDirectoryHandle.entries",
            test_expr: "typeof FileSystemDirectoryHandle.prototype.entries === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::High,
            description: "OPFS directory async iteration (entries)",
        },
        ApiTest {
            name: "FileSystemDirectoryHandle.keys",
            test_expr: "typeof FileSystemDirectoryHandle.prototype.keys === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::Medium,
            description: "OPFS directory async iteration (keys)",
        },
        ApiTest {
            name: "FileSystemDirectoryHandle.values",
            test_expr: "typeof FileSystemDirectoryHandle.prototype.values === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::Medium,
            description: "OPFS directory async iteration (values)",
        },
        ApiTest {
            name: "FileSystemDirectoryHandle.resolve",
            test_expr: "typeof FileSystemDirectoryHandle.prototype.resolve === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::Medium,
            description: "OPFS path resolve",
        },
        ApiTest {
            name: "FileSystemDirectoryHandle[@@asyncIterator]",
            test_expr: "typeof FileSystemDirectoryHandle.prototype[Symbol.asyncIterator] === 'function'",
            category: ApiCategory::FileApi,
            priority: Priority::Medium,
            description: "OPFS @@asyncIterator",
        },
        // ========== STREAMS ==========
        ApiTest {
            name: "ReadableStream",
