...
impl WebGLManager {
    ...
    pub fn setup_webgl_context(
        ...
        canvas_element.set(
            ...
            JsValue::from(get_context_fn.to_js_function(context.realm())),
            false,
            context,
        )?;
        Ok(())
    ...
    fn create_2d_context(
        ...
        ctx_2d.set(
            js_string!("font"),
            JsValue::from(js_string!("10px sans-serif")),
            true,
            context,
        )?;
        ...
        ctx_2d.set(
            js_string!("fillRect"),
            JsValue::from(fill_rect_fn.to_js_function(context.realm())),
            false,
            context,
        )?;
        ...
        ctx_2d.set(
            js_string!("fillText"),
            JsValue::from(fill_text_fn.to_js_function(context.realm())),
            false,
            context,
        )?;
    ...
    fn create_webgl_context(
        ...
        let get_parameter_fn = unsafe {
            NativeFunction::from_closure(move |_, args, context| {
                ...
                match param {
                    ...
                    35724 => Ok(JsValue::from(js_string!(
            ...
            NativeFunction::from_closure(|_, _args, ctx| {
                ...
                match ext_name.as_str() {
                    ...
                    "WEBGL_lose_context" => {
                        ...
                        ext_obj.set(
                            js_string!("loseContext"),
                            JsValue::from(lose_context_fn.to_js_function(ctx.realm())),
                            false,
                            ctx,
                        )?;
                        Ok(JsValue::from(ext_obj))
        ...
        gl_context.set(
            ...
            JsValue::from(create_texture_fn.to_js_function(context.realm())),
            false,
            context,
        )?;
        ...
        if is_webgl2 {
            ...
            let bind_vertex_array_fn = unsafe {
                NativeFunction::from_closure(|_, _args, _context| Ok(JsValue::undefined()))
            };
            gl_context.set(
                js_string!("bindVertexArray"),
                JsValue::from(bind_vertex_array_fn.to_js_function(context.realm())),
                false,
                context,
            )?;
        }
    ...
    pub fn get_webgl_renderer_info() -> (String, String) {
        ...
        let idx =
            std::collections::hash_map::DefaultHasher::new().finish() as usize % renderers.len();
