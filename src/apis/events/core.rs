...
impl EventManager {
    ...
    pub fn setup_events_api(&self, context: &mut Context) -> Result<(), boa_engine::JsError> {
        // Setup event polyfills
        super::polyfills::setup_event_polyfills(context)?;

        // Setup DOM event listeners
        super::dom_events::setup_dom_events(context)?;

        // Setup custom events
        super::custom_events::setup_custom_events(context)?;

        // Setup focus events
        super::dom_events::setup_focus_events(context)?;
